...
public class MainActivity extends Activity {
    ...
    // changelog highlighting: a MINOR release (semver x.y.0) is a feature; patch
    // releases (x.y.z, z>0) are fixes/polish. Descriptions leading with "NEW" also
    // count as features. No hand-kept list — the version number tells the truth.
